...
import {
  ...
  SheetTitle,
  SheetTrigger,
} from "@/registry/dusk-ui/ui/sheet";
import {
  ScrollArea,
  ScrollAreaContent,
} from "@/registry/dusk-ui/ui/scroll-area";

export function SheetVariantDemo() {
  const variants = ["full", "rounded"] as const;
              ...
              <ScrollArea className="p-4 border-0" scrollShadow="vertical">
                <ScrollAreaContent className="flex flex-col gap-4">
                  ...
                  <p>
                    ...
                    better claim, Because it was grassy and wanted wear; Though
                    as for that the passing there Had worn them really about the
                    same,
                  </p>
                  <p>
