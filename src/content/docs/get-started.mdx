...
This guide provides the essentials for adding **Dusk UI** components to your React application.

## Prerequisites

Dusk UI components are built with [Tailwind CSS v4](https://tailwindcss.com). Before you begin, make sure you have a React project set up with Tailwind CSS.
