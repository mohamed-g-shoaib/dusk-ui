...
Add the shared dependencies used across the Dusk UI setup:

<InstallationCommands
  type="package-installation"
  npmCommand="npm install clsx tailwind-merge tailwind-variants lucide-react tw-animate-css"
  pnpmCommand="pnpm add clsx tailwind-merge tailwind-variants lucide-react tw-animate-css"
  yarnCommand="yarn add clsx tailwind-merge tailwind-variants lucide-react tw-animate-css"
  bunCommand="bun add clsx tailwind-merge tailwind-variants lucide-react tw-animate-css"
/>

Component pages include their own manual installation instructions for any extra packages a copied component needs, such as `@base-ui/react`, `react-day-picker`, `input-otp`, or `motion`.
...
If you want to copy a component manually instead of using the registry command, open that component's page and use the `Manual` tab to install its exact dependencies.
