---
title: Theming
description: Customize Dusk UI's design system with CSS variables and global styles
---

Theming allows you to maintain a consistent look and feel across your application.

Dusk UI uses CSS variables for theming. You can customize everything from colors to component styles using standard CSS.

## How It Works

Dusk UI's theming system is built on top of [Tailwind CSS v4](https://tailwindcss.com/docs/theme)'s theme. When you import `tailwindcss`, it:
